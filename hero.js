...
function assemble(g,J,P){
  ...
  if(P.headgear==='helmet'){
    ...
    // afro sits high & back so the face (glasses, nose, mouth) stays clear
    const puffs=[
      [0,0.26,-0.03],[0.22,0.22,-0.03],[-0.22,0.22,-0.03],
      [0.16,0.15,-0.22],[-0.16,0.15,-0.22],[0,0.17,-0.28],
      [0.29,0.12,-0.08],[-0.29,0.12,-0.08],
      [0.22,0.26,-0.13],[-0.22,0.26,-0.13],[0,0.32,-0.05],
      [0.13,0.18,0.10],[-0.13,0.18,0.10],            // front hairline, above the brow
      [0.27,0.06,-0.18],[-0.27,0.06,-0.18],
      [0.05,0.32,-0.18],[-0.05,0.32,-0.18]];
